...
[
	...
	"[ts:slow]The first word must cover the [c:orange]star tile[c:white] and every word must be longer than 1 letter.",
	"[ts:slow]Reach the [c:orange]target score[c:white] and play at least 1 letter on the [c:lime]green[c:white] target zone to complete the level.",
